  ...
  function aazeen_extension_import_files() {
   global $AAZEEN_EXTEN_file, $AAZEEN_EXTEN_dir, $AAZEEN_EXTEN_uri;
    ...
    array(
      ...
      'local_import_file'            => trailingslashit( $AAZEEN_EXTEN_dir ) . 'demo/business2/demo.xml',
      'local_import_widget_file'     => trailingslashit( $AAZEEN_EXTEN_dir ) . 'demo/business2/demo.wie',
      'local_import_customizer_file' => trailingslashit( $AAZEEN_EXTEN_dir ) . 'demo/business2/demo.dat',
    ...
    array(
      ...
      'import_notice'                 => '<p> '.esc_html__('For this preset required plugin SiteOrigin Page Builder','text').' </p><a class="button-primary  button" style="background: red;border: red;text-shadow: unset;" href="' .esc_url( admin_url( 'update.php?action=install-plugin&plugin=siteorigin-panels&_wpnonce=b4b15add90' ) ).'" target="_blank">Install</a>',
    ),
    array(
